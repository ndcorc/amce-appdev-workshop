...
## Objectives
- Create AMCe Backend Project
    - Explore Initial Backend
- Create Roles for Backend Users
- Set Environment Policies (optional)

## Required Artifacts
- The following lab requires an Oracle Public Cloud account that will be supplied by your instructor.


# Create Initial Credit Union Project
...
- On the **Home** page you are provided helpful information to get you started working with AMCe. At the top is a multi-page banner with links to tutorials, videos, sample app downloads, and official AMCe documentation.

    ![](images/100/100-2-1.png)

- Beneath this banner, on the left, are video tutorials of key AMCe features and, on the right, a helpful guide to learning AMCe based on different roles that might be using the platform.

    ![](images/100/100-1.png)

- To start exploring Autonomous Mobile Cloud Enterprise for ourselves, first **click** on the hamburger menu ![alt text](images/100/menu.png) to pull up the sidebar navigation menu. In this menu, we have each of the core AMCe components: (1) **Mobile Apps**,(2) Mobile Application Accelerator or **MAX Apps**, (3) Intelligent **Bots**, and (4) **Analytics**.

  ![](images/100/100-3.png)

- Also in this menu is the environment **Settings** dropdown which includes **Deleted Artifacts**, **Policies**, and **Credentials**.
